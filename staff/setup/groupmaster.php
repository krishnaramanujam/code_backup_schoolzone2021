...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-11"><h3 style="font-weight:bold;font-style:italic;" class="font_all"><i class="fa fa-clock-o text-primary" aria-hidden="true"></i>  Group Master</h3></div>   
    </div>
    ...
    <div class="col-md-12"> 
     ...
     <div class="col-md-9">
         ...
         <table class="table table-striped" id="InstanceMaster_Table">
             <thead>
                 <tr><th>Sr No.</th><th style="text-align:left;">Group Name</th><th>Abbreviation</th><th>Previous Group Id</th><th>Operations</th></tr>
             </thead>
             <tbody>
                 <?php  $instance_fetch_q = mysqli_query($mysqli,"SELECT setup_groupmaster.* FROM `setup_groupmaster` WHERE setup_groupmaster.programmaster_Id = '$program_sel'");
                 $i = 1; while($r_instance_fetch = mysqli_fetch_array($instance_fetch_q)){  ?>
                     <tr> 
                         <td style="width:10%"><?php echo $i; ?></td>
                         <td style="width:20%;text-align:left;"><?php echo $r_instance_fetch['group_name']; ?></td>
                         ...
                         <div class="btn-group btn-group-xs" role="group" aria-label="...">
                             ...
                             <div class="btn-group" role="group">
                                 <a href="#Edit_Scroll"><button type="button" class="btn btn-default edit_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Edit Group Instance" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#33b5e5;"></span></button></a>
                             </div>
                             <div class="btn-group" role="group">
                                 <button type="button" class="btn btn-default delete_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Delete Group Instance" data-toggle="tooltip"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:#ff3547;"></span></button>
                             </div>
                             </div>

                             <input type="hidden" value="<?php echo $r_instance_fetch['Id']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_Id">
                             <input type="hidden"  value="<?php echo $r_instance_fetch['group_name']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_group_name">
                             ...
                             <input type="hidden"  value="<?php echo $r_instance_fetch['previous_group_id']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_previous_group_id">
         ...
         <div class="panel panel-default InstanceCreate_Model">
             ...
             <div class="panel-body">
                 <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="add_group_name" name="add_group_name" placeholder="Enter Program Name">
                     <br>
                     ...
                     <br>
                     <label for="email">Enter Previous Group Id*  </label>
                     <input type="text" class="form-control" id="add_previous_group_id" name="add_previous_group_id" placeholder="Enter Program Code">
                     <br>
         ...
         <div class="panel panel-default EventSelect_Model" >
             ...
             <div class="panel-body">
                 <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="edit_group_name" name="edit_group_name" placeholder="Enter Program Name">
                     <br>
                     ...
                     <br>
                     <label for="email">Edit Previous Group Id*  </label>
                     <input type="text" class="form-control" id="edit_previous_group_id" name="edit_previous_group_id" placeholder="Enter Program Code">
                     <br>
                     <label for="email">program*  </label>
...
$('#FilterForm').submit(function(e){
    ...
    $.ajax({
        url:'./setup/groupmaster.php?Generate_View='+'u',
        type:'GET',
...
$('#submit_addinstance').click(function(event){
   ...
   var add_previous_group_id = $('#add_previous_group_id').val();
   var add_programmaster_Id = $('#add_programmaster_Id').val();
   
   var program_sel = $('#program_sel').val();


    if(add_group_name == '' || add_abbreviation == '' || add_previous_group_id == '' || add_programmaster_Id == ''){
        iziToast.warning({
            title: 'Empty Fields',
    ...
    $.ajax({
        url:'./setup/setup_api.php?Add_GroupInstance='+'u',
        type:'POST',
        data: {add_group_name:add_group_name,add_abbreviation:add_abbreviation,add_previous_group_id:add_previous_group_id, add_programmaster_Id:add_programmaster_Id},
        dataType: "json",
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing Instance?')) {
        $.ajax({
            url:'./setup/setup_api.php?Delete_GroupInstance='+'u',
            type: 'POST',
...
$('.edit_instance_btn').click(function(event){
    ...
    var fetch_Edited_group_name = createURL.searchParams.get('fetch_edit_group_name');
    var fetch_Edited_previous_group_id = createURL.searchParams.get('fetch_edit_previous_group_id');
    ...
    $('#edit_group_name').val(fetch_Edited_group_name);
    $('#edit_previous_group_id').val(fetch_Edited_previous_group_id);
...
$('#submit_editinstance').click(function(event){
    ...
    $.ajax({
        url:'./setup/setup_api.php?Edit_GroupInstance='+'u',
        type:'POST',
        data: EditData,
        dataType: "json",
...
$('#import_file_submit').on('click', function(event){
    ...
    setTimeout(function(){
        ...
        $("#DisplayDiv").css("display", "none");
        jQuery.ajax({
            url: './setup/setup_api.php?Add_GroupInstance_InBulk=u',
            type: 'POST',
