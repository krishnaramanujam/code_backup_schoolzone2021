...
$q = "SELECT fee_headertype.* FROM fee_headertype Order By sequence Asc";
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6"><h3 style="font-weight:bold;font-style:italic;" class="font_all"><i class="fa fa-clock-o text-primary" aria-hidden="true"></i> Fee Header Type Master</h3>
        </div>   
    </div>
            ...
            <table class="table table-striped" id="InstanceMaster_Table">
                ...
                <tbody>
                    ...
                    $i = 1; while($r_instance_fetch = mysqli_fetch_array($instance_fetch_q)){  ?>
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $r_instance_fetch['headertype_name']; ?></td>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <input type="hidden"  value="<?php echo $r_instance_fetch['headertype_name']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_headertype_name">
...
<!------------------------------------------------------------------------------------------------------------------------->
            <div class="panel panel-default InstanceCreate_Model">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="email"> Fee Header Type Name*  </label>
                        <input type="text" class="form-control" id="add_headertype_name" name="add_headertype_name" placeholder="Enter Header Type Name">
                        <br>
            ...
            <div class="panel panel-default EventSelect_Model" id="Edit_Scroll">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <label for="email"> Fee Header Type*  </label>
                        <input type="text" class="form-control" id="edit_headertype_name" name="edit_headertype_name" placeholder="Enter Fee Header Type">
                        <br>
                        <label for="email">Abbreviation*  </label>
                        <input type="text" class="form-control" id="edit_abbreviation" name="edit_abbreviation" placeholder="Enter Abbreviation" required>
                        <br>
                        <label for="email">Sequence*  </label>
                        <input type="text" class="form-control" id="edit_sequence" name="edit_sequence" placeholder="Enter Sequence" required>
...
$('.edit_instance_btn').click(function(event){
    ...
    var fetch_Edited_headertype_name = createURL.searchParams.get('fetch_edit_headertype_name');
    ...
    $('#edit_headertype_name').val(fetch_Edited_headertype_name);
...
$.ajax({
    url:'./setup/setup_api.php?Edit_FeeHeaderTypeInstance='+'u',
    type:'POST',
    data: EditData,
    dataType: "json",
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing bank?')) {
        $.ajax({
            url:'./setup/setup_api.php?Delete_FeeHeaderTypeInstance='+'u',
            type: 'POST',
...
$('#submit_addinstance').click(function(event){
   var add_headertype_name = $('#add_headertype_name').val();
   var add_abbreviation = $('#add_abbreviation').val();
   var add_sequence = $('#add_sequence').val();


    if(add_headertype_name == '' || add_abbreviation == '' || add_sequence == ''){
        iziToast.warning({
            title: 'Empty Fields',
    ...
    $.ajax({
        url:'./setup/setup_api.php?Add_FeeHeaderTypeInstance='+'u',
        type:'POST',
        data: {add_headertype_name:add_headertype_name, add_abbreviation:add_abbreviation, add_sequence:add_sequence},
        dataType: "json",
...
$('#import_file_submit').on('click', function(event){
    ...
    setTimeout(function(){
        ...
        $("#DisplayDiv").css("display", "none");
        jQuery.ajax({
            url: './setup/setup_api.php?Add_FeeHeaderTypeInstance_InBulk=u',
            type: 'POST',
