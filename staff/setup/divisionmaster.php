...
$q = "SELECT setup_divisionmaster.* FROM setup_divisionmaster Where setup_divisionmaster.sectionmaster_Id = '$SectionMaster_Id'";
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6"><h3 style="font-weight:bold;font-style:italic;" class="font_all"><i class="fa fa-clock-o text-primary" aria-hidden="true"></i> Division Master</h3>
        </div>   
    </div>
            ...
            <table class="table table-striped" id="InstanceMaster_Table">
                ...
                <tbody>
                    ...
                    $i = 1; while($r_instance_fetch = mysqli_fetch_array($instance_fetch_q)){  ?>
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $r_instance_fetch['Division']; ?></td>
                            <td>
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-default delete_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Delete Division" data-toggle="tooltip"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:#ff3547;"></span></button>
                            </div>


                                <div class="btn-group" role="group">
                                    <a><button type="button" class="btn btn-default edit_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Edit Division" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#33b5e5;"></span></button></a>
                                </div>


                                
                                <input type="hidden" value="<?php echo $r_instance_fetch['Id']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_Id">
                                <input type="hidden"  value="<?php echo $r_instance_fetch['Division']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_Division">
            ...
            <div class="panel panel-default InstanceCreate_Model">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="add_Division" name="add_Division" placeholder="Enter Division">
            ...
            <div class="panel panel-default EventSelect_Model" id="Edit_Scroll">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <label for="email">Division Name*  </label>
                        <input type="text" class="form-control" id="edit_Division" name="edit_Division" placeholder="Enter Division">
...
$('.edit_instance_btn').click(function(event){
    ...
    var fetch_Edited_Division = createURL.searchParams.get('fetch_edit_Division');

    //Assign Value To Editable Compoents
    $('#edit_InstanceId').val(fetch_Edited_Id);
    $('#edit_Division').val(fetch_Edited_Division);
...
$.ajax({
    url:'./setup/setup_api.php?Edit_DivisionInstance='+'u',
    type:'POST',
    data: EditData,
    dataType: "json",
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing Division?')) {
        $.ajax({
            url:'./setup/setup_api.php?Delete_DivisionInstance='+'u',
            type: 'POST',
...
$('#submit_addinstance').click(function(event){
   var add_Division = $('#add_Division').val();
    ...
    $.ajax({
        url:'./setup/setup_api.php?Add_DivisionInstance='+'u',
        type:'POST',
        data: {add_Division:add_Division},
        dataType: "json",
...
$('#import_file_submit').on('click', function(event){
    ...
    setTimeout(function(){
        ...
        $("#DisplayDiv").css("display", "none");
        jQuery.ajax({
            url: './setup/setup_api.php?Add_DivisionInstance_InBulk=u',
            type: 'POST',
