...
$.ajax({
    url:'./setup/setup_api.php?Edit_SemesterInstance='+'u',
    type:'POST',
    data: EditData,
    dataType: "json",
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing Semester?')) {
        $.ajax({
            url:'./setup/setup_api.php?Delete_SemesterInstance='+'u',
            type: 'POST',
...
$('#submit_addinstance').click(function(event){
   var add_Semester_Name = $('#add_Semester_Name').val();
   var add_odd_even = $('#add_odd_even').val();
   var add_Previous_Semester_Id = $('#add_Previous_Semester_Id').val();

    if(add_Semester_Name == '' || add_odd_even == '' || add_Previous_Semester_Id == ''){
        iziToast.warning({
            title: 'Empty Fields',
    ...
    $.ajax({
        url:'./setup/setup_api.php?Add_SemesterInstance='+'u',
        type:'POST',
        data: {add_Semester_Name:add_Semester_Name, add_odd_even:add_odd_even, add_Previous_Semester_Id:add_Previous_Semester_Id},
        dataType: "json",
