...
$q = "SELECT setup_bankmaster.* FROM setup_bankmaster";
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6"><h3 style="font-weight:bold;font-style:italic;" class="font_all"><i class="fa fa-clock-o text-primary" aria-hidden="true"></i> Bank Master</h3>
        </div>   
    </div>
                    ...
                    $i = 1; while($r_instance_fetch = mysqli_fetch_array($instance_fetch_q)){  ?>
                        ...
                        <tr>
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-default delete_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Delete bank" data-toggle="tooltip"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:#ff3547;"></span></button>
                            </div>


                                <div class="btn-group" role="group">
                                    <a><button type="button" class="btn btn-default edit_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Edit bank" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#33b5e5;"></span></button></a>
                                </div>


                                
                                <input type="hidden" value="<?php echo $r_instance_fetch['Id']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_Id">
                                <input type="hidden"  value="<?php echo $r_instance_fetch['bank_name']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_bank_name">
            ...
            <div class="panel panel-default InstanceCreate_Model">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="add_bank_name" name="add_bank_name" placeholder="Enter Bank Name">
                        <br>
            ...
            <div class="panel panel-default EventSelect_Model" id="Edit_Scroll">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <label for="email">Bank Name*  </label>
                        <input type="text" class="form-control" id="edit_bank_name" name="edit_bank_name" placeholder="Enter Bank Name">
                        <br>
                        <label for="email">Abbreviation*  </label>
...
$('.edit_instance_btn').click(function(event){
    ...
    var fetch_Edited_bank_name = createURL.searchParams.get('fetch_edit_bank_name');
    ...
    $('#edit_bank_name').val(fetch_Edited_bank_name);
...
$.ajax({
    url:'./superadmin/superadmin_api.php?Edit_bankInstance='+'u',
    type:'POST',
    data: EditData,
    dataType: "json",
    success:function(edit_instance_res){  
        if(edit_instance_res == '200'){
            $.ajax({
                url:'./superadmin/bank_master.php',
                type:'GET',
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing bank?')) {
        $.ajax({
            url:'./superadmin/superadmin_api.php?Delete_BankInstance='+'u',
            type: 'POST',
...
$('#submit_addinstance').click(function(event){
   ...
   var add_department_type = $('#add_department_type').val();
    ...
    if(add_bank_name == '' || add_abbreviation == ''){
        iziToast.warning({
            title: 'Empty Fields',
    ...
    $.ajax({
        url:'./superadmin/superadmin_api.php?Add_bankInstance='+'u',
        type:'POST',
        data: {add_bank_name:add_bank_name, add_abbreviation:add_abbreviation},
        dataType: "json",
...
$('#import_file_submit').on('click', function(event){
    ...
    setTimeout(function(){
        ...
        $("#DisplayDiv").css("display", "none");
        jQuery.ajax({
            url: './superadmin/superadmin_api.php?Add_BankInstance_InBulk=u',
            type: 'POST',
