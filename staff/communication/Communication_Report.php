...
<div class="box">
<div class="col-md-12"><h4><i><b>  Communication Report</b></i>
</div>
...
<?php 
    if(isset($_GET['Generate_View'])){
        ...
        $comm_fetch_q = mysqli_query($mysqli, "SELECT comm_message_log.* FROM comm_message_log JOIN comm_sms_header_ids ON comm_sms_header_ids.Id = comm_message_log.SenderHeader Where comm_sms_header_ids.sectionmaster_Id = '$SectionMaster_Id' AND   comm_message_log.timestamp >= '$start_f 00:00:00' AND comm_message_log.timestamp <= '$end_f 24:00:00' AND comm_message_log.message_type = '1'");
            ...
            if($rows_comm_fetch > '0'){
                ...
                While($r_comm_fetch = mysqli_fetch_array($comm_fetch_q)){
                    ...
                    if($r_comm_fetch['userIdType'] == 'SBM_Id'){
                      ...
                      WHERE
                        user_studentbatchmaster.Id = '$r_comm_fetch[User_Id]' ");
...
$('#search_access').click(function(e){
    ...
    $.ajax({
        url:'./communication/Communication_Report.php?Generate_View='+'u',
        type:'GET',
        data: formdata,
