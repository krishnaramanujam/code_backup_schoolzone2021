...
<?php 
    if(isset($_GET['Generate_View'])){
        ...
        $comm_fetch_q = mysqli_query($mysqli, "SELECT comm_message_log.* FROM comm_message_log  WHERE moduleType = 'Communication' AND comm_message_log.timestamp >= '$start_f 00:00:00' AND comm_message_log.timestamp <= '$end_f 24:00:00'");
            ...
            if($rows_comm_fetch > '0'){
                ...
                While($r_comm_fetch = mysqli_fetch_array($comm_fetch_q)){
                    ...
                    if($r_comm_fetch['userIdType'] == 'SBM_Id'){
                      ...
                      WHERE
                        user_studentbatchmaster.Id = '$r_comm_fetch[User_Id]' AND setup_batchmaster.Id = '$batch_sel' ");
