...
$q = "SELECT setup_departmentmaster.* FROM setup_departmentmaster Where setup_departmentmaster.sectionmaster_Id = '$SectionMaster_Id'";
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6"><h3 style="font-weight:bold;font-style:italic;" class="font_all"><i class="fa fa-clock-o text-primary" aria-hidden="true"></i> Department Master</h3>
        </div>   
    </div>
            ...
            <table class="table table-striped" id="InstanceMaster_Table">
                ...
                <tbody>
                    ...
                    $i = 1; while($r_instance_fetch = mysqli_fetch_array($instance_fetch_q)){  ?>
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $r_instance_fetch['department_name']; ?></td>
                            <td><?php echo $r_instance_fetch['abbreviation']; ?></td>
                            <td><?php echo $r_instance_fetch['department_type']; ?></td>
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-default delete_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Delete Department" data-toggle="tooltip"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:#ff3547;"></span></button>
                            </div>


                                <div class="btn-group" role="group">
                                    <a><button type="button" class="btn btn-default edit_instance_btn" id="<?php echo $r_instance_fetch['Id']; ?>" data-placement="top" title="Edit Department" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#33b5e5;"></span></button></a>
                                </div>


                                
                                <input type="hidden" value="<?php echo $r_instance_fetch['Id']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_Id">
                                <input type="hidden"  value="<?php echo $r_instance_fetch['department_name']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_department_name">
                                ...
                                <input type="hidden" value="<?php echo $r_instance_fetch['department_type']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_department_type">
            ...
            <div class="panel panel-default InstanceCreate_Model">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="add_department_name" name="add_department_name" placeholder="Enter Department Name">
                        <br>
                        ...
                        <br>
                        <label for="email">Department Type*  </label>
                        <input type="text" class="form-control" id="add_department_type" name="add_department_type" placeholder="Enter Department Type">
            ...
            <div class="panel panel-default EventSelect_Model" id="Edit_Scroll">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <label for="email">Department Name*  </label>
                        <input type="text" class="form-control" id="edit_department_name" name="edit_department_name" placeholder="Enter Department Name">
                        <br>
                        <label for="email">abbreviation*  </label>
                        <input type="text" class="form-control" id="edit_abbreviation" name="edit_abbreviation" placeholder="Enter abbreviation">
                        <br>
                        <label for="email">Department Type*  </label>
                        <input type="text" class="form-control" id="edit_department_type" name="edit_department_type" placeholder="Enter Department Type">
...
$('.edit_instance_btn').click(function(event){
    ...
    var fetch_Edited_department_name = createURL.searchParams.get('fetch_edit_department_name');
    var fetch_Edited_abbreviation = createURL.searchParams.get('fetch_edit_abbreviation');
    var fetch_Edited_department_type = createURL.searchParams.get('fetch_edit_department_type');


    //Assign Value To Editable Compoents
    $('#edit_InstanceId').val(fetch_Edited_Id);
    $('#edit_department_name').val(fetch_Edited_department_name);
    $('#edit_abbreviation').val(fetch_Edited_abbreviation);
    $('#edit_department_type').val(fetch_Edited_department_type);
...
$.ajax({
    url:'./user_management/user_management_api.php?Edit_DepartmentInstance='+'u',
    type:'POST',
    data: EditData,
    dataType: "json",
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing Department?')) {
        $.ajax({
            url:'./user_management/user_management_api.php?Delete_DepartmentInstance='+'u',
            type: 'POST',
...
$('#submit_addinstance').click(function(event){
   ...
   var add_department_type = $('#add_department_type').val();
    ...
    if(add_department_name == '' || add_abbreviation == '' || add_department_type == '' ){
        iziToast.warning({
            title: 'Empty Fields',
    ...
    $.ajax({
        url:'./user_management/user_management_api.php?Add_DepartmentInstance='+'u',
        type:'POST',
