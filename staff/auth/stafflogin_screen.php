...
?>
  ...
  <h3 class="text-center">Welcome to Staff Portal</h3>
    ...
    <div class="col-md-12 col-sm-12" style="display: grid;place-items: center;">
      ...
      <div class="panel panel-info img-thumbnail">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Registered Users login with Username and password.</h3>
        </div>
        ...
        <div class="row">
          ...
          <div class="form-group" style="padding:15px;">
            ...
            <input type="text" class="form-control" id="login_username" name="login_username" placeholder="Enter Username" value="">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
              <input type="hidden" value="" id="SL_Id" name="SL_Id">
              <label for="email">Enter Username*</label>
                  <input type="text" class="form-control" id="user_loginId" name="user_loginId" placeholder="Enter Username" >
              ...
              <label for="email">Enter New Password*</label>
                      <input type="password" class="form-control" id="new_password" name="new_password" placeholder="Enter New Password" value="" disabled>
              <label for="email">Confirm Your Password*</label>
                      <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Your Password" value="" disabled>  
        </div>
        <div class="modal-footer">
              ...
              <button type="button" class="btn save_btn_effect verify_otp_details btn-success" value="Login" style="padding-left: 40px;    padding-right: 40px;" disabled> CONFIRM OTP</button>
            
              <button type="button" class="btn save_btn_effect verify_password_details btn-primary" value="Login" style="padding-left: 40px;    padding-right: 40px;" disabled> SUBMIT</button>
...
$('.sendotp_mobile_details').click(function(e){
    ...
    $.ajax({
        ...
        type: 'POST',
        data: {user_loginId:user_loginId, SM_Id:SM_Id},
        dataType: "json",
        success:function(srh_gr_response){

          //Checking Status 
          if(srh_gr_response['status'] == 'success') {
            var SL_Id = srh_gr_response['SL_Id'];
            // --------------SMS--------------------------------------------------------------------------------
...
$('.verify_otp_details').click(function(e){
    ...
    $.ajax({
        ...
        type: 'POST',
        data: {SL_Id:SL_Id,user_otp:user_otp},
        dataType: "json",
        success:function(srh_gr_response){
          ...
          if(srh_gr_response['status'] == 'success') {
            ...
            $('.verify_password_details').prop("disabled", false);

            alert('Verfication Completed, Now you can set your New Password, Do Not Refresh Your Page');
...
$('.verify_password_details').click(function(e){
    e.preventDefault();
    ...
    $.ajax({
        url: './onlinelogin_api.php?Request_NewPasswordChanged='+'u',
        type: 'POST',
        data: {SL_Id:SL_Id,new_password:new_password, confirm_password:confirm_password},
        dataType: "json",
        success:function(srh_gr_response){
          ...
          if(srh_gr_response['status'] == 'success') {
            ...
            alert('Your New Password is Successfully Set')
            window.open('https://dvsl.in/schoolzone2021/staff/auth/login.php?sectionmaster_Id='+ SM_Id, '_self');
