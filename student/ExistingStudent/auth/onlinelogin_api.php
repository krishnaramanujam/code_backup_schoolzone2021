...
if(isset($_GET['Change_PersonalDetails'])){
    ...
    // Checking the Number is Valid or Not
    $checking_pnr = mysqli_query($mysqli, "SELECT user_stafflogin.Id AS SR_Id, user_stafflogin.reg_mobile_no As registeredMobileNo, user_stafflogin.verificationCode FROM user_stafflogin WHERE user_stafflogin.Id = '$User_Id'  AND user_stafflogin.date_of_birth = '$enter_Date'"); 
