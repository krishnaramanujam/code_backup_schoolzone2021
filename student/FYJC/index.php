...
if ( isset( $_SESSION['schoolzone_student']['SectionMaster_Id'] ) AND  isset( $_SESSION['schoolzone_student']['Activecandidateregister_Id'] ) ) 
{
    $SectionMaster_Id = $_SESSION['schoolzone_student']['SectionMaster_Id'];
    $Activecandidateregister_Id = $_SESSION['schoolzone_student']['Activecandidateregister_Id'];
...
<!-- ======================================================================================= -->
    ...
    <input type="hidden" value="<?php echo $Activecandidateregister_Id; ?>" id="UserId">
